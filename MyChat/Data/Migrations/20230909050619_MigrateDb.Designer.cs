...
namespace MyChat.Data.Migrations
{
    ...
    [Migration("20230909050619_MigrateDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyChat.Models.AppIdentityUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyChat.Models.AppIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyChat.Models.Message", b =>
                {
                    ...
                    b.HasOne("MyChat.Models.AppIdentityUser", "Sender")
                        .WithMany()
